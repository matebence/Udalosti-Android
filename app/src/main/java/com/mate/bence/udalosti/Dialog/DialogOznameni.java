...
public class DialogOznameni {
    ...
    public DialogOznameni(Activity activity, String titul, String oznamenie) {
        ...
        dialog.setContentView(R.layout.dialog_chyb);

        TextView dialogTitul = dialog.findViewById(R.id.dialog_chyb_titul);
        TextView dialogText = dialog.findViewById(R.id.dialog_chyb_text);

        dialogTitul.setText(titul);
        dialogText.setText(oznamenie);

        Button zavorit = dialog.findViewById(R.id.dialog_chyb_zatvorit);
