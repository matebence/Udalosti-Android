...
public interface Requesty {
    ...
    Call<Zoznam> udalosti(
            @Field("email") String email,
            @Field("id_udalost") String idUdalost,
            @Field("datum") String datum,
            @Field("stat") String stat,
            @Field("od") int od,
            @Field("pocet") int pocet,
            @Field("token") String token);

    @FormUrlEncoded
    @POST("udalosti/index.php/udalosti/udalosti_podla_pozicie")
    Call<Zoznam> udalostiPodlaPozicie(
            @Field("email") String email,
            @Field("id_udalost") String idUdalost,
            @Field("datum") String datum,
            @Field("stat") String stat,
    ...
    @FormUrlEncoded
    @POST("udalosti/index.php/udalosti/vyhladavenie_udalosti")
    Call<Zoznam> hladanaUdalost(
            @Field("email") String email,
            @Field("nazov") String nazov,
            @Field("stat") String stat,
            @Field("token") String token);
    ...
    @FormUrlEncoded
    @POST("udalosti/index.php/udalosti/podrobnosti_udalosti")
    Call<Zoznam> podrobnostiUdalosti(
            @Field("email") String email,
            @Field("id_udalost") int idUdalost,
            @Field("token") String token);

    @FormUrlEncoded
    @POST("udalosti/index.php/pouzivatelia")
    Call<Zoznam> vsetci(
            @Field("email") String email,
            @Field("od") int od,
            @Field("pocet") int pocet,
    ...
    @FormUrlEncoded
    @POST("udalosti/index.php/vztahy")
    Call<Zoznam> priatelia(
            @Field("email") String email,
            @Field("od") int od,
            @Field("pocet") int pocet,
            @Field("token") String token);
    ...
    @FormUrlEncoded
    @POST("udalosti/index.php/pouzivatelia/vyhladavanie_pouzivatelov")
    Call<Zoznam> hladanyPouzivatel(
            @Field("email") String email,
    ...
    Call<Zoznam> zoznamNaplanovanychUdalosti(
            @Field("email") String email,
            @Field("od") int od,
            @Field("pocet") int pocet,
            @Field("token") String token);
    ...
    @FormUrlEncoded
    @POST("udalosti/index.php/pozvanky")
    Call<Zoznam> oznameniaZiadosti(
            @Field("email") String email,
            @Field("od") int od,
            @Field("pocet") int pocet,
            @Field("token") String token);
